	...
	SubShader
	{
		...
		Pass
		{
				 ...
				 ) : SV_Target
			{
				...
				float3 Color = ( ( tex2DNode10 * _Tint ) * step( temp_cast_0 , tex2DNode19 ) ).rgb;
...
Node;AmplifyShaderEditor.StepOpNode;24;487.7049,191.2231;Inherit;False;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;26;669.1528,-55.96688;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
