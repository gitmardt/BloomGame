...
Shader "EyesTransparent"
{
	Properties
	{
		...
		[HDR]_Tint("Tint", Color) = (1,0.4070103,0,0)
	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float2 texCoord18 = v.ase_texcoord.xy * _Tiling + ( _Speed * _TimeParameters.x );
				float4 tex2DNode19 = tex2Dlod( _noisev2, float4( texCoord18, 0, 0.0) );
				...
				float3 vertexValue = ( _Strength * ( float4( v.normalOS , 0.0 ) * tex2DNode19 ) ).rgb;
				 ...
				 ) : SV_Target
			{
				...
				float temp_output_24_0 = step( _Dissolve , tex2DNode19.r );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( ( tex2DNode10 * _Tint ) * temp_output_24_0 ).rgb;
				float Alpha = ( tex2DNode10.r * temp_output_24_0 );
				float AlphaClipThreshold = tex2DNode10.r;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float4 tex2DNode10 = tex2D( _Eyes, texCoord27 );
				float2 texCoord18 = IN.ase_texcoord2.xy * _Tiling + ( _Speed * _TimeParameters.x );
				float4 tex2DNode19 = tex2D( _noisev2, texCoord18 );
				float temp_output_24_0 = step( _Dissolve , tex2DNode19.r );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float4 tex2DNode10 = tex2D( _Eyes, texCoord27 );
				float2 texCoord18 = IN.ase_texcoord.xy * _Tiling + ( _Speed * _TimeParameters.x );
				float4 tex2DNode19 = tex2D( _noisev2, texCoord18 );
				float temp_output_24_0 = step( _Dissolve , tex2DNode19.r );
				

				surfaceDescription.Alpha = ( tex2DNode10.r * temp_output_24_0 );
				surfaceDescription.AlphaClipThreshold = tex2DNode10.r;
		...
		Pass
		{
				 ...
				 )
			{
				...
				float4 tex2DNode10 = tex2D( _Eyes, texCoord27 );
				float2 texCoord18 = IN.ase_texcoord1.xy * _Tiling + ( _Speed * _TimeParameters.x );
				float4 tex2DNode19 = tex2D( _noisev2, texCoord18 );
				float temp_output_24_0 = step( _Dissolve , tex2DNode19.r );
...
/*ASEBEGIN
Version=19302
Node;AmplifyShaderEditor.SimpleTimeNode;14;-1266.415,592.979;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;15;-1240.082,380.1616;Inherit;False;Property;_Speed;Speed;4;0;Create;True;0;0;0;False;0;False;1,1;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;16;-1048.106,528.4473;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.Vector2Node;17;-1050.853,715.1771;Inherit;False;Property;_Tiling;Tiling;3;0;Create;True;0;0;0;False;0;False;1,1;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;25;145.8464,174.1302;Inherit;False;Property;_Dissolve;Dissolve;6;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;10;-344,-36;Inherit;True;Property;_Eyes;Eyes;0;0;Create;True;0;0;0;False;0;False;-1;f0e8d64f6607d4c4bae28554e6c91f69;f0e8d64f6607d4c4bae28554e6c91f69;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.StepOpNode;24;497.2454,194.8008;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;26;669.1528,-55.96688;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;33;656.6932,107.0978;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;918.5071,72.79794;Float;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;13;EyesTransparent;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;2;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;UniversalMaterialType=Unlit;True;5;True;12;all;0;False;True;1;5;False;;10;False;;1;1;False;;10;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;2;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForward;False;False;0;;0;0;Standard;21;Surface;1;638457484857309752;  Blend;0;638457477788688937;Two Sided;0;638457478082574820;Forward Only;0;638457477997010284;Cast Shadows;1;0;  Use Shadow Threshold;0;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;False;True;True;True;False;False;True;True;True;False;False;;False;0
...
ASEEND*/
//CHKSM=42E89D6D111E407521E88EDFC067370109704729